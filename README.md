...
<li><b>SQL</b> (for analysis)</li>
  SQL Skills Used: Common Table Expressions, Subqueries, Joins, Views, Aggregate Functions, Scalar Functions, Date and Time Functions, Conditional Functions, Conversion Functions
